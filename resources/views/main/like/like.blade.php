...
@section('content')
    ...
    <section id="product" class="container">
        <h2 class="title">🔥 محصولات پسندیده شده</h2>
            ...
            @forelse($products as $item)
                <div style="margin: 20px">
                    ...
                    <div>
                        ...
                        <a href="{{ route('reaction.product.delete',['lang' => app()->getLocale(),'like' => $item->like_id]) }}">
                            <button style="background-color: blue;cursor: pointer;color: white;margin-top: 20px;width: 100%" class="card button">حذف محصول</button>
                        </a>
                    </div>
                </div>
            @empty
