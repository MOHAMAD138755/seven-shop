...
@section('content')
    <div class="users-page">
        ...
        <div class="page-header">
            <div>
                <h1>دسته بندی ها</h1>
                <p>ادمین وبسایت میتواند دسته بندی ها را اضافه و حذف و ویرایش کند</p>
            </div>
        ...
        <div class="users-grid">
            ...
            <div class="card form-card" id="userFormCard">
                ...
                <form action="{{ route('Dashboard.AddCategory',['lang' => app()->getLocale()]) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="english_name" placeholder="Enter english_name">
                    </div>
